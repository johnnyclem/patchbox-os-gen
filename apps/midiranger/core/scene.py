...
A scene is a plain JSON-able dict of the engine's parameter tree (routes,
arps, quantizer, harmonizer, FX, LFOs). Capturing is a copy; recalling is an
apply; morphing blends two scenes: numeric leaves interpolate, everything
else (names, booleans, the route set) switches at the halfway point —
half a route is not a thing.
"""
